    ...
    <div className="p-3 py-3" id="addExpense">
            ...
            <form className="text-white mt-5">
                <div className="mb-6">
                    ...
                    <input type="text" className="outline-none text-md rounded-lg block w-full p-2.5 bg-gray-700 border border-gray-600 focus:ring-blue-500 focus:border-blue-500" placeholder="Reason for the expense"/>
                     {/* <p className="mt-2 text-sm text-green-500"><span className="font-medium">Well done!</span> Some success message.</p>  */}
                  </div>
                <div className="mb-6 inline-block">
                <label for="category" className="block mb-1 text-md font-medium">Select an option</label>
                  <select id="category" className="outline-none text-md rounded-lg block w-full p-2.5 bg-gray-700 border border-gray-600 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div className="mb-6">  
                <label  className="block mb-1 text-md font-medium">On which date the expense occured</label>
